...
public class Rapport9Test {
	...
	public void buildRapportTest() throws DRException, InterruptedException, FileNotFoundException, ParseException {
		...
		rapport9.build(startDateTest, endDateTest);

		Assert.assertTrue(rapport9.dataSource != null);

		final File file = new File(rapport9.getFilePath());
		System.out.println(rapport9.getFilePath());
