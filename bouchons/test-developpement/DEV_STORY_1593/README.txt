...
En tant que RELAIS, je veux émettre les informations sur les lignes via le service LinesDiscovery 2.4

Suivre les étapes du testlink STIF-IVTR_TEST-1:
Envoi d'une requête SM et reception d'une réponse valide avec nouveaux passages:

Ce test permet de vérifier que le relais envoie une requête StopMonitoring à un producteur.
 Le producteur envoie une réponse valide, le relais stocke le résultat dans son tampon.
...
Afficher les logs de la machine d'administration et les logs de la machine reception
...
Vérifier que le partenaire 100WSIVSIRI est en version siri 2.4
Importer le projet test-developpement/DEV_STORY_1593/soapui/LineDiscovery24-soapui-project.xml dans soapUI et lancer la requete.
