...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://localhost:8080/SNCF-test116', true, true,'http://localhost:8080/SNCF-test116',true,'http://localhost:8080/bouchon-diffuseur',10,1,'RPC',true,false);
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://localhost:8080/bouchon-producteur',true,'http://localhost:8080/RATP-test243',10,1,'RPC',true,false, 'http://localhost:8081/test417Diffuseur', true);
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, diffuseurgeneralmessageurl, diffuseurgeneralmessageused) 
VALUES ('3','KEOLIS','KEOLIS','DIFFUSEUR', '2.4', true,true,'http://localhost:8080/bouchon-producteur',true,'http://localhost:8080/RATP-test243',10,1,'RPC',true,false, 'http://localhost:8080/KEOLIS-test416', true);
...
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://localhost:8081/test417Producer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
INSERT INTO job_detail (ID,CRON,PARTICIPANTREF, SIRIREQUESTTYPE, REQUETE) VALUES (nextval('SEQ_job_detail'),'5/10 * * * * ?','SNCF-ACCES','GM','{"address":"http://localhost:8081/test417Producer","version":"2.4","participantRef":"SNCF-ACCES"}');
