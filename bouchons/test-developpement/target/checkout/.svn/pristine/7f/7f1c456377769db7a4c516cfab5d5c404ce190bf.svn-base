...
INSERT INTO job_detail(
            id,  cron, sirirequesttype, participantref, requete)
    VALUES (nextval('seq_job_detail'), '0/15 * * * * ?',   
            'SM', '100WSIVSIRI', '{"address":"http://localhost:8081/GMProducer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108926:"}');
