...
En tant que Relais je veux récupérer auprès des producteurs les informations sur les arrêts via le service StopPointsDiscovery 2.2
...
6- Vérifier/Cocher la case services producteurs stoppointdiscovery et ajouter l'adresse http://localhost:8080/Test979
7- Enregistrer
