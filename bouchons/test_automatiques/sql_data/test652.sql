--Veillez à initialiser les référentiels avec les jeux des tests fonctionnels.
...
INSERT INTO participant(
            ...
            typepartenaire, siriversion, style, protocole)
    VALUES (1, 'SNCF', 1, 10, 'SNCF-ACCES','DIFFUSEUR','2.4','RPC', 'HTTP');
INSERT INTO participant(
            id, name, nombrearretparrequete, nombrerequeteparminute, participantref, 
            typepartenaire, siriversion, style, protocole)
    VALUES (2, 'RATP', 1, 10, '100WSIVSIRI','DIFFUSEUR','2.4','RPC', 'HTTP');
INSERT INTO participant(
            id, name, nombrearretparrequete, nombrerequeteparminute, participantref, 
            typepartenaire, siriversion, style, protocole)
    VALUES (3, 'KEOLIS', 1, 10, 'KEOLIS_SIVIK','DIFFUSEUR','2.4','RPC', 'HTTP');
