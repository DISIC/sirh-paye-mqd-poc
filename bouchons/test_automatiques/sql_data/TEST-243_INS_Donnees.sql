...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://${ip_producer}:${port_producer}/SNCF-test116', true, true,'http://${ip_producer}:${port_producer}/SNCF-test116',true,'http://${ip_producer}:${port_producer}/bouchon-diffuseur',10,10,'RPC',true,false, true, 'http://${ip_producer}:${port_producer}/SNCF-test116', 'HTTP');
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://${ip_producer}:${port_producer}/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/RATP-test243',10,10,'RPC',true,false, true, 'HTTP');
