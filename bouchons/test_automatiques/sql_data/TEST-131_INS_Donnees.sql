...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://${ip_producer}:${port_producer}/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/RATP-test131',10,1,'RPC',true,false, true, 'HTTP');
