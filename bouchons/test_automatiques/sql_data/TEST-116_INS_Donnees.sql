...
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, producteursubscribeused, protocole) 
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://${ip_producer}:${port_producer}/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/RATP-test',10,1,'RPC',true,false, true, 'HTTP');
...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','GS','{"address":"http://${ip_producer}:${port_producer}/SNCF-test116"}', 'SNCF-ACCES');
