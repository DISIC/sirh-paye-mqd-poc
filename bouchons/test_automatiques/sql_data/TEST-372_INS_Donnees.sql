...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.4:8080/SNCF-test116', true, true,'http://10.222.9.4:8080/SNCF-test116',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',true,false, 'HTTP');
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.4:8080/RATP-test243',10,1,'RPC',true,false, 'http://10.222.9.205:8080/test402Producer', true, 'HTTP');
