...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', false,true,'http://192.54.144.229:8080/bouchon-producteur',false,'http://${ip_producer}:${port_producer}/RATP-test243',10,1,'RPC',true,false, 'http://10.222.9.205:8080/test402Diffuseur', true, 'HTTP');
