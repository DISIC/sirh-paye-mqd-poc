...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://localhost:8880/SNCF-test116', true, true,'http://${ip_producer}:${port_producer}/SNCF-test249',true,'http://${ip_producer}:${port_producer}/bouchon-diffuseur',10,1,'RPC',false,true, 'HTTP');
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/RATP-test249',true ,10,1,'RPC',true,false,'http://10.222.9.205:8080/Ano209', 'HTTP');
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, protocole) 
...
UPDATE synchro_referentiels SET dernieremaj = NOW() AT TIME ZONE 'GMT' WHERE id = 'REFLEX';
...
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://${ip_producer}:${port_producer}/injection_IVTR1","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
