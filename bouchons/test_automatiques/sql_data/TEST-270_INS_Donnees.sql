...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.2', true, 'http://10.222.9.4:8080/SNCF-test116', true, true,'http://${ip_producer}:${port_producer}/test270Producer',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',false,true, 'HTTP');
...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://${ip_producer}:${port_producer}/test270Producer","version":"2.2","monitoringRef":"STIF:StopPoint:Q:108940:"}');
