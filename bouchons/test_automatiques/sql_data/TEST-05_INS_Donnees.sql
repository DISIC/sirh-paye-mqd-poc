...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','SM','{"address":"http://${ip_producer}:${port_producer}/test5Producer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}', 'SNCF-ACCES');
