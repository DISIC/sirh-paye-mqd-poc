...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://${ip_producer}:${port_producer}/SNCF-test116', true, true,'http://${ip_producer}:${port_producer}/SNCF-test116',true,'http://${ip_producer}:${port_producer}/bouchon-diffuseur',10,1,'RPC',true,false, true, 'http://${ip_producer}:${port_producer}/SNCF-test116', 'HTTP');

-- TEST- 573 est un test parent de TEST-247: LA RATP doit avoir l'autorisation de diffuseur pour linesdiscovery 
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, diffuseurlinesdiscoveryused, protocole) 
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://${ip_producer}:${port_producer}/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/RATP-test126',10,1,'RPC',true,false,true, 'HTTP');
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, protocole) 
VALUES ('3','KEOLIS','KEOLIS','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://${ip_producer}:${port_producer}/KEOLIS-test245',10,1,'RPC',true,false, 'HTTP');
...
VALUES (nextval('SEQ_arret_diffuseur'),'108925',1);
INSERT INTO arret_diffuseur (id, monitoringRef, participant_id) 
