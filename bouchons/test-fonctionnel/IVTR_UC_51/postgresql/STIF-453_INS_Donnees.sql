...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.214:8080/SNCF-test116', true, true,'http://10.222.9.214:8080/SNCF-test116',true,'http://10.222.9.214:8080/bouchon-diffuseur',10,1,'RPC',false,true, true, 'http://10.222.9.214:8080/SNCF-test116');
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://10.222.9.214:8080/bouchon-producteur',true,'http://10.222.9.214:8080/STIF-453',10,1,'RPC',true,false);
...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://10.222.9.205:8080/test1Producer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
