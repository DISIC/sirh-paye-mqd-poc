...
VALUES ('1','SNCF','SNCF-ACCES','2.4',true,'PRODUCTEUR_DIFFUSEUR', true,'http://10.222.9.205:8080/SNCF-test116',true,'http://localhost:8110/bouchon-diffuseur',10,1,'RPC',true,false);
INSERT INTO participant (id, name, participantref, siriversion, partenaireActif, typepartenaire, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete) 
VALUES ('2','RATP','100WSIVSIRI','2.4',true,'PRODUCTEUR_DIFFUSEUR', true,'http://10.222.9.205:8080/RATP-test116',true,'http://192.54.144.229:8080/RATP-test',10,1,'RPC',true,false);
...
UPDATE reflex_zone_de_lieu SET reflex_lieu_d_arret_id = '100' WHERE id = '112'; 
