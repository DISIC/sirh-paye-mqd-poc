...
VALUES ('1','SNCF','SNCF-ACCES','2.4',true,'PRODUCTEUR_DIFFUSEUR', true,'http://10.222.9.4:8080/SNCF-test153',true,'http://localhost:8110/bouchon-diffuseur',10,1,'RPC',true,false);
INSERT INTO participant (id, name, participantref, siriversion, partenaireActif, typepartenaire, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete) 
VALUES ('2','RATP','100WSIVSIRI','2.4',true,'DIFFUSEUR', true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.4:8080/RATP-test153',10,1,'RPC',true,false);
...
VALUES (nextval('SEQ_arret_producteur'),null,'STIF:StopPoint:Q:108924:',false,1);
INSERT INTO arret_producteur (id, dateDerniereDemande, monitoringRef, souhaite, participant_id) 
VALUES (nextval('SEQ_arret_producteur'),null,'STIF:StopPoint:Q:108923:',false,2);
