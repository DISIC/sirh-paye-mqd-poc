...
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://10.222.9.205:8080/injection","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108925:"}');
