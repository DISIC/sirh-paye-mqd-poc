...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','2012-01-01','SM', 'SNCF-ACCES', '{"address":"http://10.222.9.205:8080/test275Producer_2","version":"2.2","monitoringRef":"STIF:StopPoint:Q:108940:"}');
