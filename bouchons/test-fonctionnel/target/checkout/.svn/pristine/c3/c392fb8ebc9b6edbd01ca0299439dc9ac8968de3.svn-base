...
VALUES ('1','SNCF','SNCF-ACCES','PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.205:8080/SNCF-test119', true, true,'http://10.222.9.205:8080/SNCF-test119',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',true,false);

INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, producteurcheckstatusused, producteurcheckstatusurl, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete) 
VALUES ('3','KEOLIS','KEOLIS', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.4:8080/KEOLIS-test119', true, true,'http://10.222.9.4:8080/KEOLIS-test119',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',true,false);
