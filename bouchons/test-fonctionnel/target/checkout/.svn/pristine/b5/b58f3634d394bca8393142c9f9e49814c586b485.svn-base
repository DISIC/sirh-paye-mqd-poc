...
-- insertion d'un job GetSiri vers le Producer inconnu
INSERT INTO job_detail (ID,CRON,VERSION,SIRIREQUESTTYPE,REQUETE) 
VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','2012-01-01','GS','{"address":"http://10.222.9.208:8080/test44ProducerInconnu","version":"2.4","listIdentifiantArrets":["STIF:StopPoint:Q:108940:"]}');
