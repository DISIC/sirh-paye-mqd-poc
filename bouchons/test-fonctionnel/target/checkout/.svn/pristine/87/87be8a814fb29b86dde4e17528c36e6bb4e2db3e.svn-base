...
INSERT INTO operator (id, name, participant_id, active) VALUES ('1','RATP','2',true);
INSERT INTO operator (id, name, participant_id, active) VALUES ('2','SNCF','1',true);

INSERT INTO operator_code (id, operatorref, operator_id) VALUES ('1','SNCF','2');
INSERT INTO operator_code (id, operatorref, operator_id) VALUES ('2','RATP','1');
...
VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','2012-01-01','SM','{"address":"http://10.222.9.208:8080/test2Producer_2","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
