...
VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','2012-01-01','GS','{"address":"http://10.222.9.208:8080/test14Producer_1","version":"2.4","listIdentifiantArrets":["STIF:StopPoint:Q:108940:","STIF:StopPoint:Q:108941:"]}');
