...
INSERT INTO job_detail (ID,CRON,VERSION,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('SEQ_job_detail'),'*/30 * * * * ?','2012-01-01','SM', 'SNCF-ACCES', '{"address":"http://10.222.9.205:8080/test439ProducerSM","version":"2.2","monitoringRef":"STIF:StopPoint:Q:108940:"}');
INSERT INTO job_detail (ID,CRON,VERSION,PARTICIPANTREF, SIRIREQUESTTYPE, REQUETE) VALUES (nextval('SEQ_job_detail'),'5/10 * * * * ?','2012-01-01','SNCF-ACCES','GM','{"address":"http://10.222.9.205:8080/test439ProducerGM","version":"2.2","participantRef":"SNCF-ACCES"}');
