...
VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','2012-01-01','SM','{"address":"http://10.222.9.208:8080/test10Producer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
