...
VALUES ('1','SNCF','SNCF-ACCES','2.4',true,'PRODUCTEUR_DIFFUSEUR', true,'http://10.222.9.205:8080/SNCF-test133',true,'http://localhost:8110/bouchon-diffuseur',10,1,'RPC',true,false);
INSERT INTO participant (id, name, participantref, siriversion, partenaireActif, typepartenaire, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete) 
VALUES ('2','RATP','100WSIVSIRI','2.4',true,'DIFFUSEUR', true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.205:8080/test623Diffuseur',10,1,'RPC',true,false);
