...
VALUES ('2','RATP','100WSIVSIRI','PRODUCTEUR_DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.4:8080/RATP-test249',true ,10,1,'RPC',true,false,'http://10.222.9.205:8080/Ano209');
...
INSERT INTO ligne_producteur (id, lineref, participant_id) VALUES ('1','STIF:Line::C00040:','1');
INSERT INTO ligne_producteur (id, lineref, participant_id) VALUES ('2','STIF:Line::C00041:','2');
INSERT INTO ligne_producteur (id, lineref, participant_id) VALUES ('3','STIF:Line::C00042:','3');
