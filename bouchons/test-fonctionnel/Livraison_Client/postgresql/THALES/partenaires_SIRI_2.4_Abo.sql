...
VALUES (nextval('SEQ_participant'),'THALES-Diff','THALES-DIFF', 'DIFFUSEUR', '2.4', true, 'http://[ip]:[port]/SNCF-test116', true, true,'http://[ip]:[port]/SNCF-test249',true,'http://[ip]:[port]/Diffuseur',10,1,'RPC',false,true, '10:00', '15:00');
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, producteurcheckstatusused, producteurcheckstatusurl, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, plagedebut, plagefin, producteursubscribeused, producteursubscribeurl) 
VALUES (nextval('SEQ_participant'),'THALES-Test','THALES-PROD', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://[ip]:[port]/Producteur', true, true,'http://[ip]:[port]/Producteur',true,'http://[ip]:[port]/Producteur',10,1,'RPC',true,false, '10:00', '15:00', true, 'http://[ip]:[port]/Producteur');
