...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.205:8080/SNCF-test116', true, true,'http://10.222.9.205:8080/SNCF-test249',true,'http://10.222.9.205:8080/bouchon-diffuseur',10,1,'RPC',false,true);
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.205:8080/RATP-test249',true ,10,1,'RPC',true,false,'http://10.222.9.205:8080/Ano209');
...
VALUES ('3','KEOLIS','KEOLIS','DIFFUSEUR', '2.4', true,true,'http://10.222.9.205:8080/bouchon-producteur',true,'http://10.222.9.205:8080/KEOLIS-test245',10,1,'RPC',true,false);
...
VALUES (nextval('SEQ_job_detail'),'*/15 * * * * ?','GS','{"address":"http://10.222.9.208:8080/test99Producer_SNCF","version":"2.4","listIdentifiantArrets":["STIF:StopPoint:Q:110048:","STIF:StopPoint:Q:109925:","STIF:StopPoint:Q:109926:"]}');
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE,REQUETE) 
VALUES (nextval('SEQ_job_detail'),'*/15 * * * * ?','GS','{"address":"http://10.222.9.208:8080/test99Producer_RATP","version":"2.4","listIdentifiantArrets":["STIF:StopPoint:Q:109956:","STIF:StopPoint:Q:109974:","STIF:StopPoint:Q:109943:","STIF:StopPoint:Q:110048:"]}');
