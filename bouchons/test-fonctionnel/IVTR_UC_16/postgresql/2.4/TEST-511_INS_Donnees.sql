...
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, diffuseurgeneralmessageused, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, diffuseurgeneralmessageurl, diffuseurstoppointdiscoveryused, diffuseurlinesdiscoveryused) 
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://10.222.9.4:8080/RATP-test249',true ,10,1,'RPC',true,false,'http://10.222.9.205:8080/Ano209', true, true);
...
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','CS', 'SNCF-ACCES', '{"address":"http://10.222.9.205:8080/injection","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
