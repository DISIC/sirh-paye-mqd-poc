...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.4:8080/SNCF-test116', true, true,'http://[ip:port]/test672Producer',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',false, true, true);
