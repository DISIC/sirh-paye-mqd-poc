...
VALUES ('1','SNCF','SNCF-ACCES','PRODUCTEUR_DIFFUSEUR', '2.4', true,true,'http://[ip:port]/injection',true,'http://[ip:port]/injection',true ,10,1,'RPC',true,false,'http://[ip:port]/test656Diffuseur');
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, diffuseurgeneralmessageused, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, diffuseurgeneralmessageurl) 
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://[ip:port]/injection',true,'http://[ip:port]/injection',true ,10,1,'RPC',true,false,'http://[ip:port]/test656Diffuseur2');
INSERT INTO participant (id, name, participantref, typepartenaire, siriversion, partenaireActif, producteurstopmonitoringused, producteurstopmonitoringurl, diffuseurstopmonitoringused, diffuseurstopmonitoringurl, nombreArretParRequete, nombreRequeteParMinute, style, activationmodeabonnement, activationmoderequete, diffuseurgeneralmessageurl) 
VALUES ('3','KEOLIS','KEOLIS','DIFFUSEUR', '2.4', true,true,'http://192.54.144.229:8080/bouchon-producteur',true,'http://[ip:port]/KEOLIS-test245',10,1,'RPC',true,false,'http://[ip:port]/test656Diffuseur2');
...
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://[ip:port]/injection","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108940:"}');
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE, PARTICIPANTREF, REQUETE) VALUES (nextval('seq_job_detail'),'*/30 * * * * ?','SM', 'SNCF-ACCES', '{"address":"http://[ip:port]/test656Producer","version":"2.4","monitoringRef":"STIF:StopPoint:Q:108941:"}');
INSERT INTO job_detail (ID,CRON,PARTICIPANTREF, SIRIREQUESTTYPE, REQUETE) VALUES (nextval('SEQ_job_detail'),'5/10 * * * * ?','SNCF-ACCES','GM','{"address":"http://[ip:port]/injection","version":"2.4","participantRef":"SNCF-ACCES"}');
