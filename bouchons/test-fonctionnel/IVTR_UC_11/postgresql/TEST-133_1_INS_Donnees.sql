...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://localhost:8091/SNCF-test116', true, true,'http://localhost:8091/SNCF-test116',true,'http://localhost:8091/bouchon-diffuseur',10,1,'RPC',true,false);
...
VALUES ('2','RATP','100WSIVSIRI','DIFFUSEUR', '2.4', true,true,'http://localhost:8091/bouchon-producteur',true,'http://localhost:8091/RATP-test',10,1,'RPC',true,false);
