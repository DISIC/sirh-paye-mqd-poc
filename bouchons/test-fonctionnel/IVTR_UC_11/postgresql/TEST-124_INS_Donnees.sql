...
VALUES ('1','SNCF','SNCF-ACCES', 'PRODUCTEUR_DIFFUSEUR', '2.4', true, 'http://10.222.9.205:8080/SNCF-test124', true, true,'http://10.222.9.205:8080/SNCF-test124',true,'http://10.222.9.4:8080/bouchon-diffuseur',10,1,'RPC',true,false);
