...
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','CS','{"address":"http://10.222.9.205:8080/test326Producer1"}','SNCF-ACCES');
INSERT INTO job_detail (ID,CRON,SIRIREQUESTTYPE,REQUETE, PARTICIPANTREF) 
VALUES (nextval('seq_job_detail'),'*/10 * * * * ?','CS','{"address":"http://10.222.9.205:8080/test326Producer2"}','100WSIVSIRI');
