package com.sirh.mqd.commons.constantes;

/**
 * Constantes génériques au projet Cloudwatt.
 *
...
public class Constantes {
	...
	/**
	 * Constante d'ajout d'un caractère de retour à la ligne selon l'environnement
	 */
	public static final String LINE_BREAK = System.getProperty("line.separator");

	/**
	 * Caractère séparateur pour séparer les différents éléments d'une clé Redis
	 */
	public static final String SEPARATOR_REDIS = "|";
	...
	/**
	 * Regex pattern début de version Siri cf: stif siri p84 //2.0:FR-IDF-2.4
	 */
	public static final String SIRI_REGEX_START_PATTERN = "\\d+\\.\\d+\\:FR-IDF-";
