...
public class GenericUtilsTest {
	...
	/**
	 * Test de la méthode
	 * {@link GenericUtils#ajouterHttpSeparateur(StringBuilder, String)}.<br/>
	 ...
	 * Test de la méthode
	 * {@link GenericUtils#ajouterHttpSeparateur(StringBuilder, String)}.<br/>
	 * Cas où l'URL est non null et le chemin non null. L'URL n'a pas de
	 * séparateur à la fin et le chemin n'a pas de séparateur au début.<br/>
	 * L'URL finale doit être la concaténation de l'URL initiale + séparateur +
	 * chemin.
	 */
	@Test
	 ...
	 * Test de la méthode
	 * {@link GenericUtils#ajouterHttpSeparateur(StringBuilder, String)}.<br/>
	 * Cas où l'URL est non null et le chemin non null. L'URL a un séparateur à
	 * la fin et le chemin n'a pas de séparateur au début.<br/>
	 ...
	 * {@link GenericUtils#ajouterHttpSeparateur(StringBuilder, String)}.<br/>
	 * Cas où l'URL est non null et le chemin non null. L'URL n'a pas de
	 * séparateur à la fin et le chemin a un séparateur au début.<br/>
	 * L'URL finale doit être la concaténation de l'URL initiale + chemin.
	 */
	@Test
	 ...
	 * Cas où l'URL est non null et le chemin non null. L'URL n'a pas de
	 * séparateur à la fin et le chemin a un séparateur au début.<br/>
	 * L'URL finale doit être la concaténation de l'URL initiale + chemin (avec
	 * un seul séparateur entre les deux composantes).
	 */
	@Test
	...
	/**
	 * Tests de :
	 * {@link SGAUtils#creerHttpUrl(String, Integer, String, String...)}
	 */

	/**
	 * Test de la méthode
	 * {@link GenericUtils#creerHttpUrl(String, Integer, String, String...)}.
	 * <br/>
	 * Cas où le serveur est null, peu importe la valeur des autres paramètres.
	 * <br/>
	 ...
	 * {@link GenericUtils#creerHttpUrl(String, Integer, String, String...)}.
	 * <br/>
	 * Cas où le serveur est non null, le port positif et l'application non
	 * null.<br/>
	 * Le résultat doit être une URL avec le protocole, le serveur, le port et
	 * l'application.
	 */
	@Test
	 ...
	 * {@link GenericUtils#creerHttpUrl(String, Integer, String, String...)}.
	 * <br/>
	 * Cas où le serveur est non null, le port positif, l'application non null
	 * et plusieurs chemins avec ou sans séparateurs.<br/>
	 * Le résultat doit être une URL avec le protocole, le serveur, le port,
	 * l'application les chemins.
	 */
	@Test
	public void testCreerHttpUrl05ServeurNonNullPortPositifAppliNonNullPlusieursChemins() throws Exception {
		final String urlResultat = GenericUtils.creerHttpUrl(null, "monServeur", 1234, "monAppli", "chemin0",
	 ...
	 * <ul>
	 * <li>
	 * {@link com.sirh.mqd.commons.utils.GenericUtils#roundDecimal(Float, int)}
	 * </li>
	 * </ul>
	 * Cas nominal pour arrondir à 2 décimales un float avec plusieurs décimales
	 * après la virgule.
	 */
	@Test
	public void testRoundDecimalCasNominal00() {
		...
		final Float result = GenericUtils.roundDecimal(value, decimalNumber);
	 ...
	 * </li>
	 * </ul>
	 * Cas nominal pour arrondir à 5 décimales un float avec plusieurs décimales
	 * après la virgule.
	 */
	@Test
	 ...
	 * </li>
	 * </ul>
	 * Cas nominal pour arrondir à 0 décimale un float avec plusieurs décimales
	 * après la virgule.
	 */
	@Test
