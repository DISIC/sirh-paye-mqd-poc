...
public class JsonUtilsTest {
	...
	/**
	 * Test de la méthode {@link GenericUtils#deserializerJSON(String, Class)}.<br/>
	 * Cas nominal.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Test de la méthode {@link GenericUtils#deserializerJSON(String, Class)} .<br/>
	 * Cas où la chaine en entrée n'est pas au bon format. Le résultat est alors <code>null</code>.<br/>
	...
	/**
	 * Test de la méthode {@link GenericUtils#deserializerJSON(String, Class)}.<br/>
	 * Cas où la chaine en entrée ne correspond pas au type de l'objet attendu. Le résultat est alors <code>null</code>.<br/>
	...
	public void testDeserializerJSON02TypeIncompatible() throws IOException {
		...
		// L'attibut "monChampIncorrect" n'existe pas dans la classe "monChampIncorrect"
	...
	public void testDeserializerFichierJSON00CasNominal() throws IOException {
		final MonObjet objetResultat = JsonUtils.deserializerJSON(new File("./src/test/resources/objet.json"), MonObjet.class);
	...
	public void testSerializerJSON00CasNULL() throws IOException {
		...
		Assertions.assertThat(chaineResultat).isEqualTo("{\"monBoolean\":true,\"monEntier\":1234,\"maChaine\":null,\"maListe\":null}");
